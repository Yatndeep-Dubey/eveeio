const Details = () => {
  return (
    <section className="mx-auto w-fit">
      <p className="font-bold w-[21.313rem] text-sm md:text-lg md:w-[35rem] lg:w-fit">
        We will call you to discuss complete details <br /> about the program
        which includes:
      </p>

      <div className="h-[34rem] w-[21.313rem] bg-purplish rounded-xl p-5 text-sm my-5 shadow md:w-[35rem] lg:w-[23rem] xl:w-[35rem] lg:h-[77rem]">
        ...
        assumenda architecto perspiciatis est praesentium eligendi quisquam
        alias, iusto ex, dolore deserunt odio pariatur! Recusandae.
        <br />
        <br /> A corporis voluptatum ab maiores incidunt ratione consequatur
        nam, eos ipsam voluptatem reprehenderit obcaecati praesentium, amet
        facere neque nulla error beatae, officia quae quas! Consectetur
        distinctio ab <br />
        <br /> facere omnis tenetur nam incidunt dolores itaque. Fugit iure non
        magni reprehenderit et ad. Porro illum consequuntur beatae? Incidunt,
        ...
        <p className="hidden xl:block">
          ...
          aspernatur dolore. Ducimus laborum laudantium culpa incidunt ipsam
          magnam, a, facere accusantium veritatis, veniam quisquam excepturi.
          Maiores fuga ea pariatur repudiandae expedita sint, officia sunt?
          Labore commodi omnis, quasi dolor ea, quod, blanditiis quo aliquid
